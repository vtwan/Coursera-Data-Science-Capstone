...
#### Note:
The source codes for ui.R and server.R files are also available on the [GitHub repo](https://github.com/vtwan/Coursera-Data-Science-Capstone)

Presentation Slide decks are available on the [RPubs page](http://rpubs.com/twan/DS_Capstone)