...
write.csv(quadgram[quadgram$freq > 1,],"Capstone/quadgram.csv",row.names=F)
quadgram <- read.csv("Capstone/quadgram.csv",stringsAsFactors = F)
saveRDS(quadgram,"Capstone/quadgram.RData")
...
write.csv(trigram[trigram$freq > 1,],"Capstone/trigram.csv",row.names=F)
trigram <- read.csv("Capstone/trigram.csv",stringsAsFactors = F)
saveRDS(trigram,"Capstone/trigram.RData")
...
write.csv(bigram[bigram$freq > 1,],"Capstone/bigram.csv",row.names=F)
bigram <- read.csv("Capstone/bigram.csv",stringsAsFactors = F)
saveRDS(bigram,"Capstone/bigram.RData")